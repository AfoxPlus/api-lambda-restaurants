...
export class GooglePlaceDataSource {
  ...
  private toRestaurant(place: PlaceResponse): Restaurant {
    ...
    const restaurant: Restaurant = {
      key: place.id.slice(0, 6),
      name: place.displayName.text,
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla porttitor tortor a turpis vulputate, ut suscipit elit pharetra.",
      phone: place.internationalPhoneNumber,
      email: "",
      address: place.formattedAddress,
      urlImageLogo: "https://img.freepik.com/vector-gratis/logotipo-restaurante-dibujado-mano_23-2151335494.jpg",
      urlImageBanner: "https://s3.amazonaws.com/media.visitcolumbusms.org/20180307155048/placeholder-banner.jpg",
      ...
      types: place.types.map(item => ({ name: item })),
